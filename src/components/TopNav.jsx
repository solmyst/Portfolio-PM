...
const TopNav = () => {
  const [docName, setDocName] = useState('Anush_Gupta_PRD_v1.0');
            ...
            <div className="flex flex-col justify-center h-full pt-[2px]">
              <div className="flex items-center gap-1 ml-1">
                <input 
                  ...
                  className={`text-[18px] text-doc-text bg-transparent outline-none border border-transparent hover:border-gray-300 focus:border-doc-blue rounded px-1 min-w-[200px] h-[24px] ${docName === 'Anush_Gupta_PRD_v1.0' ? 'typing-cursor' : ''}`}
                />
